...
The prediction accuracy on the training dataset and Cross-validation data set are 99.63% and 99.76%, respectively.
I would expect the accuracy on the test dataset to be around the same.
